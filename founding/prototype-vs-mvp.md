---
description: >-
  Learn the difference between a prototype and an MVP, when to use each, and
  what you actually need before investing in full product development.
---
...
An [**MVP (Minimum Viable Product)**](prototype-vs-mvp.md#what-is-an-mvp) is a working version of the product that delivers its core value to real users.
